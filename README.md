...
@ionos-cloud/test-runner/1.11.0-beta.0 darwin-x64 node-v14.15.0
...
_See code: [src/commands/run.ts](https://github.com/ionos-cloud/sdk-test-runner/blob/v1.11.0-beta.0/src/commands/run.ts)_
<!-- commandsstop -->
